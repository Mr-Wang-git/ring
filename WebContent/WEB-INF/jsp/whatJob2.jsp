									 ...
									 <center>
											  <ul class="pager pagination navigation" style="margin: 0 auto;">
												  ...
												  <c:if test="${isHasPreviousPage}">
												    <li class="previous" style="margin: 0 auto;"><a href="whatJob?Page=${pageNum-1}"><h3><span aria-hidden="true">&larr;</span> Older</a></h3></li>
												   </c:if>
												   <!-- 没有上一页 -->
												   <c:if test="${!isHasPreviousPage}">
												    <li class="previous" style="margin: 0 auto;"><a href="whatJob?Page=${pageNum}"><h3><span aria-hidden="true">&larr;</span> Older</a></h3></li>
												   </c:if>
												    
												    <!-- 有下一页 -->
												    <c:if test="${isHasNextPage}">
												    	<li class="next" style="margin: 0 auto;"><a href="whatJob?Page=${pageNum+1}" style="color:#46b3e6"><h3 style="color:#46b3e6">Newer <span aria-hidden="true">&rarr;</span></h3></a></li>
												  	</c:if>
												  	<!-- 没有 -->
												  	<c:if test="${!isHasNextPage}">
												    	<li class="next" style="margin: 0 auto;"><a href="whatJob?Page=${pageNum}" style="color:#46b3e6"><h3 style="color:#46b3e6">Newer <span aria-hidden="true">&rarr;</span></h3></a></li>
												  	</c:if>
