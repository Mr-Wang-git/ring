		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item cta cta-colored"><a href="jobs?Page=1" class="nav-link">想要一份好工作</a></li>
			...
			<div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-center">
				<div class="col-md-10 d-flex align-items-center ">
					<div class="text w-100 text-center">
						<span class="subheading mb-2">喜欢你的工作吗？成千上万的人在找你！</span>
						<h1 class="mb-4"><span class="number" data-number="
						<c:out value="${jobcount}" default="0" />"></span>江洋!</h1>
						<p class="mb-4">我们不得不饮食、睡眠、游玩、恋爱，也就是说，我们不得不接触生活中最甜蜜的事情，不过我们必须不屈服于这些事物。</p>
						...
						<a href="jobs?Page=1" class="btn btn-secondary">搜索工作</a></p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row d-flex">
				...
				<div class="col-md-3 d-flex align-self-stretch ">
					<div class="media block-6 services d-block text-center">
						...
						<div class="media-body">
							<h3 class="heading mb-3">为自己挑选最好的团队</h3>
							<p>最好的团队才能发挥出最大的效能。</p>
						</div>
					</div>    
				</div>
				...
				<div class="col-md-3 d-flex align-self-stretch ">
					<div class="media block-6 services d-block text-center">
						...
						<div class="media-body">
							<h3 class="heading mb-3">顶尖的职业</h3>
							<p>为自己的开局挑选成最好的开局。</p>
						</div>
					</div>      
				</div>
				...
				<div class="col-md-3 d-flex align-self-stretch ">
					<div class="media block-6 services d-block text-center">
						...
						<div class="media-body">
							<h3 class="heading mb-3">找到相同经历的打工人</h3>
							<p>在交流平台找到和自己经历相似的人愉快的交流。</p>
						</div>
					</div>      
				</div>
			</div>
		...
		<div class="container">
			<div class="row justify-content-center pb-3">
				<div class="col-md-12 heading-section ftco-animate">
					<span class="subheading subheading-2">最近新增的工作</span>
					<h2 class="mb-4">本周精选职位</h2>
				</div>
			</div>
			<div class="row">
						...
						<div class="one-third d-flex align-items-start mb-4 mb-md-0">
							<div class="job-wrap">
								<div class="job-post-item-header align-items-center">
									...
									<h2 class="mr-3 text-black"><a href="">${job.positionName}</a></h2>
								</div>
								<div class="job-post-item-body d-block d-md-flex">
									<div class="mr-3"><span class="fa fa-suitcase"></span> <a href="">${job.com_id}, Inc.</a></div>
									<div class="mr-3"><span class="fa fa-map-marker"></span> <span>${job.address}, China</span></div>
									<div><a href="#" class="link bg-primary">${job.positionName}</a></div>
								</div>
							</div>
							<div class="price-rate mt-4">
								<span>每月</span>
								<span class="rate">${job.salary}</span>
							</div>
						</div>

						<div class="one-forth d-flex align-items-center mt-4 md-md-0">
							<div class="d-flex ml-lg-auto">
								<a href="jobs?Page=1" class="icon text-center d-flex justify-content-center align-items-center icon mr-2">
									<span class="fa fa-heart"></span>
								</a>
								<a href="iWhat?id=${job.com_id}" class="btn btn-primary py-2">申请职位</a>
							</div>
						</div>
					</div>
				</div><!-- end -->
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-8 text-center">
				<h2>与我们一起开始您的新工作</h2>
				<p>只要不放弃努力和追求,小草也有点缀春天的价值</p>
				<p><a href="jobs?Page=1" class="btn btn-secondary py-3 px-4">开启新生活</a></p>
			</div>
		</div>
	</div>
</section>
...
<section class="ftco-section ftco-candidates">
	<div class="container">
		<div class="row justify-content-center pb-3">
			<div class="col-md-10 heading-section text-center ftco-animate">
				<span class="subheading">打工人</span>
				<h2 class="mb-4">新简历</h2>
			</div>
		</div>
	</div>
	<div class="container">
		<div class="row ftco-animate">
				...
				<c:forEach items="${resume}" var="res">
					<div class="item col-md-3 ">
						<a href="Others?id=${res.id}" class="team text-center">
							<div class="img" style="background-image: url(/ringEmployment/EXTERNAL/img/${res.img})"></div>
							<div class="text">
								<h2>${res.name}</h2>
								<span class="position">${res.household}, China</span>
								<p>${res.evaluation}</p>
							</div>
						</a>
					</div>
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<ul class="list-unstyled">
						<li><a href="" class="pb-1 d-block">查看简历</a></li>
						<li><a href="" class="pb-1 d-block">发布新工作</a></li>
					</ul>
				</div>
			</div>
			<div class="col-md">
				<div class="ftco-footer-widget mb-4 ml-md-4">
					...
					<ul class="list-unstyled">
						<li><a href="jobs?Page=1" class="pb-1 d-block">查看工作</a></li>
						<li><a href="updateUserMy" class="pb-1 d-block">修改简历</a></li>
					</ul>
				</div>
			</div>
			<div class="col-md">
