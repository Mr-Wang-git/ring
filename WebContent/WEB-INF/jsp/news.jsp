		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active" ><a href="news" class="nav-link">资讯</a></li>
		...
		<div class="row no-gutters slider-text align-items-end">
			<div class="col-md-12 ftco-animate mb-5">
				<p class="breadcrumbs mb-0">
					<span class="mr-3"> <a href="index">首页 <i
							class="fa fa-chevron-right"> </i>
					</a>
					</span> <span>资讯 <i class="fa fa-chevron-right"></i>
					</span>
				</p>
				<h1 class="mb-3 bread">最新资讯</h1>
			</div>
		</div>
	</div>
	</section>
		...
		<c:forEach items="${newss}" var="news">
			...
			<div class="col-md-6 col-lg-3 d-flex ftco-animate">
				<div class="blog-entry align-self-stretch">
					<a href="newsDetails?id=${news.id}" class="block-20"
						style="background-image: url(/ringEmployment/EXTERNAL/img/${news.img});"> </a>
					<div class="text">
						<div class="meta mb-2">
							<div>
								<a href="newsDetails?id=${news.id}">${news.time}</a>
							</div>
							<div>
								<a href="newsDetails?id=${news.id}">Admin</a>
							</div>
						</div>
						<h3 class="heading">
							<a href="newsDetails?id=${news.id}">${news.title}</a>
						</h3>
						<p>${news.content}</p>
					</div>
				</div>
