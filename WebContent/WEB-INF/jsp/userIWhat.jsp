		...
		<c:forEach items="${mess}" var="mess">
				...
				<div class="col-md-12 col-lg-6 d-flex ftco-animate">
					<div class="blog-entry align-self-stretch">
						<div class="text">
							<h3 class="heading">
								对象名:<a href="company?id=${mess.com_id}"><c:if test="${name!=null}">${name}</c:if></a>
							</h3>
							<p>${mess.content}</p>
						</div>
					</div>
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<ul
						...
						<li class="ftco-animate"><a href="http://weixin.com"><span
								class="fa fa-weixin"></span></a></li>
						<li class="ftco-animate"><a href="http://qq.com"><span
								class="fa fa-qq"></span></a></li>
						<li class="ftco-animate"><a href="http://github.com"><span
