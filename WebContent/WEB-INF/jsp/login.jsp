				...
				<div class="w3_info">
					...
					<form id="requi">
						<div class="input-group">
							...
							<input type="email" id="account" placeholder="Account" required="requi">
						</div>
						<div class="input-group">
							<span><i class="fas fa-key" aria-hidden="true"></i></span> 
							<input type="Password" id="password" placeholder="Password" required="requi">
						</div>
						<div class="form-row bottom">
							<a href="ForgetTheAccount" class="forgot">忘记账号?</a> 
							<a href="ForgetThePassword" class="forgot">忘记密码？</a>
						</div>
						<button class="btn btn-primary btn-block" id="sub" type="button">登录</button>
					</form>

					<p class="account">
						没有账号? <a href="signin">注册</a>
					</p>
				</div>
			</div>
			<!-- //main content -->
