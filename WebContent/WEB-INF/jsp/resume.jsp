		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item cta cta-colored"><a href="resumes" class="nav-link">想要一个好的打工人</a></li>
						...
						<div class="one-third d-flex align-items-start mb-4 mb-md-0">
							<div class="job-wrap">
								<div class="job-post-item-header align-items-center">
									<a href="Others?id=${resume.id}" class="subadge">${resume.name}</a>
									<h2 class="mr-3 text-black"><a href="">${resume.major}</a></h2>
								</div>
									 ...
									 <center>
											  <ul class="pager pagination navigation" style="margin: 0 auto;">
												  ...
												  <c:if test="${isHasPreviousPage}">
												    <li class="previous" style="margin: 0 auto;"><a href="resumes?Page=${pageNum-1}"><h3><span aria-hidden="true">&larr;</span> Older</a></h3></li>
												   </c:if>
												   <!-- 没有上一页 -->
												   <c:if test="${!isHasPreviousPage}">
												    <li class="previous" style="margin: 0 auto;"><a href="resumes?Page=${pageNum}"><h3><span aria-hidden="true">&larr;</span> Older</a></h3></li>
												   </c:if>
												    
												    <!-- 有下一页 -->
												    <c:if test="${isHasNextPage}">
												    	<li class="next" style="margin: 0 auto;"><a href="resumes?Page=${pageNum+1}" style="color:#46b3e6"><h3 style="color:#46b3e6">Newer <span aria-hidden="true">&rarr;</span></h3></a></li>
												  	</c:if>
												  	<!-- 没有 -->
												  	<c:if test="${!isHasNextPage}">
												    	<li class="next" style="margin: 0 auto;"><a href="resumes?Page=${pageNum}" style="color:#46b3e6"><h3 style="color:#46b3e6">Newer <span aria-hidden="true">&rarr;</span></h3></a></li>
												  	</c:if>
