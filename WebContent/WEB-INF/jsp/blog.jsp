...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html">Ring聘.</a>
						...
						<div class="text">
							<div class="meta mb-2">
								...
								<c:if test="${mess.u_id != 0}">
									<div><a href="Others?id=${mess.u_id}">${mess.name}</a></div>
								</c:if>
								
								<c:if test="${mess.com_id != 0}">
									<div><a href="company?id=${mess.com_id}">${mess.name}</a></div>
								</c:if>
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<ul class="list-unstyled">
						<li><a href="resume" class="pb-1 d-block">查看简历</a></li>
